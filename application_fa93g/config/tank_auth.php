...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Global Store Management System';
$config['webmaster_email'] = 'helloworld@aashishtripathee.com';
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'aua^&2jakKAJF^&1';
$config['autologin_cookie_life'] = 60*60*24*1;
...
|--------------------------------------------------------------------------
*/
$config['db_table_prefix'] = 'aiap97af_';
